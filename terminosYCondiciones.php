...
<section>
    ...
    <div class="container-index">
        <main class="termAndconditions">
            <h2><strong>POLÍTICA DE PRIVACIDAD</strong></h2>
            <p>La presente Política de Privacidad establece los términos en que INDOMATH.SA usa y protege la información
            ...
            <p>INDOMATH.SA está altamente comprometido para cumplir con el compromiso de mantener su información segura.
            ...
            <p>Una cookie se refiere a un fichero que es enviado con la finalidad de solicitar permiso para almacenarse
                ...
                respecto al tráfico web, y también facilita las futuras <a href="" target="_blank"></a> recurrente. Otra
                función que tienen las cookies es que con ellas las web pueden reconocerte individualmente y por tanto
                brindarte el mejor servicio personalizado de su web.</p>
            <p>Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su
                ...
                puede cambiar la configuración de su ordenador para declinar las cookies. Si se declinan es posible que
                no pueda utilizar algunos de nuestros servicios.</p>
            ...
            <p>INDOMATH.SA Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en
                cualquier momento.</p>
            <br>
        </main>
    </div>
